...
class Register_Controller extends CI_Controller {
    ...
    public function register_user() {
        ...
        try {
            ...
            if ($type === 'INV' && (!isset($name) || trim($name) == '' || !isset($lastname) || trim($lastname) == '')) {
                throw new Exception("Firtname/Lastname is not set");
            }
            if ($type === 'COMPMAN' && (!isset($name) || trim($name) == '')) {
                throw new Exception("Comercial Name is not set");
            }
            ...
            $newuser->lastname = (($type === 'INV') ? $lastname : '');
            $newuser->email = $email;
