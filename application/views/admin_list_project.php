...
<script type="text/javascript">
    ...
    window.onload = function () {
        ...
        $(document).on('slidePanel::afterLoad', function (e) {
            ...
            $.ajax({
                url: "<?php echo base_url('Admin_List_Project_Controller/get_project/'); ?>" + c_project_id,
                type: "POST",
                async: false,
    ...
    function Listar() {
        $.ajax({
            url: "<?php echo base_url('Admin_List_Project_Controller/get_project_list'); ?>",
            type: "POST",
            success: function (data) {
                var resp = $.parseJSON(data);//convertir data de json
                $("#project_list").empty();
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url('Admin_List_Project_Controller/delete_project'); ?>/" + id,
                        type: "POST",
                        success: function (data) {
                            var resp = $.parseJSON(data);//convertir data de json
                            if (resp.status === "error") {
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    ...
                    $.ajax({
                        url: "<?php echo base_url('Admin_List_Project_Controller/status_project'); ?>/" + estado+"/"+c_project_id,
                        type: "POST",
                        success: function (data) {
                            var resp = $.parseJSON(data);//convertir data de json
                            if (resp.status === "error") {
