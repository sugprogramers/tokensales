                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group ">
                                ...
                                <input type="email" required class="form-control" id="inpuPaypalAcct" name="paypalacct" placeholder="Paypal Account" style="font-size: 14px; border-radius:0;">
                            </div>
                        </div>
...
<script type="text/javascript">
    window.onload = function () {
        ...
        $("#paypalacct_form").submit(function (event) {
            ...
            var paypalacct = $('#inpuPaypalAcct').val();
            if (!paypalacct) {
